...
export default {
  get: async (endpoint, slug, queryString, authCookieString) => {
    ...
    if (endpoint === endpoints.SEARCH_SELLERS) options.headers = { Accept: "application/json" };
  ...
  post: async (endpoint, form, cookieString) => {
    ...
    if (endpoint === endpoints.AUTH) options.headers = { Accept: "application/json, text/javascript, */*; q=0.01" };
